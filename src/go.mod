...
require (
	...
	github.com/bluesky-social/indigo v0.0.0-20250417233640-6b0010a646ae // indirect
	...
	github.com/letsencrypt/boulder v0.0.0-20250421205626-1ce439bc9218 // indirect
